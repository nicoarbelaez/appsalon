...
export default function AdminServiciosEdit({ servicio }: { servicio: Servicio }) {
    ...
    return (
        <>
            <Head title={`Admin — Editar: ${servicio.nombre}`} />

            <div className="mx-auto max-w-xl p-6">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Editar servicio</h1>
